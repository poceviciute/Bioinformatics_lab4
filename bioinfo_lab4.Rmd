...
sig1 <- unique (subset(results, threshold %in% c(2,3))$getsymbols)
sig2 <- unique (subset(results2, threshold %in% c(2,3))$getsymbols)
sig3 <- unique (subset(results3, threshold %in% c(2,3))$getsymbols)
